...
public final class ResisableRectangle {
    ...
    public static Rectangle create(double x, double y, double width, double height, Color dragersColor, double handleRadius) {
        Rectangle rect = new Rectangle(x, y, width, height);

        // top left resize handle:
        Circle resizeHandleNW = new Circle(handleRadius, dragersColor);
        // bind to top left corner of Rectangle:
        resizeHandleNW.centerXProperty().bind(rect.xProperty());
        resizeHandleNW.centerYProperty().bind(rect.yProperty());

        // bottom right resize handle:
        Circle resizeHandleSE = new Circle(handleRadius, dragersColor);
        ...
        // move handle:
        Circle moveHandle = new Circle(handleRadius, dragersColor);
